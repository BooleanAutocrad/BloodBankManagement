...
public class AdminServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
       ...
       case "/AdminServlet/delete":
			java.lang.String d_id = request.getParameter("d_id");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		 HttpSession session = request.getSession();
			...
			java.lang.String age = request.getParameter("age");
			
		
			java.lang.String blood_group = request.getParameter("blood_group");
			java.lang.String city = request.getParameter("city");
			java.lang.String state = request.getParameter("state");
